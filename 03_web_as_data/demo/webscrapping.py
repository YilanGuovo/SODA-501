...
wiki_url = "https://en.wikipedia.org/wiki/Donald_Trump"


# A header to address the 403 issues
headers = {
...
wiki_tables = pd.read_html(response.text, attrs={"class": "infobox"})
...
title_pattern = (r"(?:Distinguished|Liberal Arts|Roy C\.|Arnold S\.|James P\.)?"r"\s*(?:Associate\s+)?Professor[^\n\r]{0,120}")
